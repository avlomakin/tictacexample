...
{
    public class GameHandlerOnline
    {
        ...
        public void Step()
        {
            ...
            string curPlayer = _isCross ? Cell.Cross.ToString() : Cell.Nought.ToString();
            ...
            while (!ok)
            {
                ...
                try
                {
                    ...
                    ok = GameField.TrySet(_currentCell, position, _isCross ? Cell.Cross : Cell.Nought);
                    if (!ok)
